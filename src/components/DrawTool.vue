<template>
    <div>
        ...
        <div id="tool-area">
            <button id="pen-black-button" @click="penBlack">ペン(黒色)</button>
            <button id="pen-red-button" @click="penRed">ペン(赤色)</button>
            <button id="pen-blue-button" @click="penBlue">ペン(青色)</button>
